...
const Hero = () => {
  return (
    <div className="p-8 dark:bg-[#1a1a1a] ">
      ...
      <div>
        Its me Aayush Poudel. A passionate frontend developer with a strong fundamentals of blockchain and web3. I believe technology can be used to change the world.  
      </div>
      <div className="">
        <div>
